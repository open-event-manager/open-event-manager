...
function addTagFormDeleteLink($tagFormLi) {
    var $removeFormButton = $('<a href="#" class="deleteFreeField" type="remove-group"><i class="text-danger px-1 fas fa-trash" data-toggle="tooltip" title="Lösche Freifeld" data-original-title="Lösche Freifeld"></i></a>');
