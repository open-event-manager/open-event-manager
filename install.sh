...
if [[ "$dsnOrCreds" == "dsn" ]]
then
    echo Example DSN: sqlite3:////opt/open-event-manager/open-event-manager.sqlite3?mode=0666
...
read -p "Enter the server of the keycloak with /auth at the end: " keycloakServer
